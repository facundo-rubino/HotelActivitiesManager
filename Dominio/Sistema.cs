...
namespace Dominio
{
	public class Sistema
	{
        ...
        private void PrecargarDatosTercerizadas()
        {
            ...
            Tercerizada Tercerizada1 = new Tercerizada(Proveedor1, false, new DateTime(2024, 01, 12), "ActTercerizada1", "Descripcion tercerizada 1", new DateTime(2023, 01, 12), 10, 0, 10);
            ...
            Tercerizada Tercerizada3 = new Tercerizada(Proveedor1, false, new DateTime(2024, 03, 12), "ActTercerizada3", "Descripcion tercerizada 3", new DateTime(2023, 03, 12), 12, 0, 20);
            ...
            Tercerizada Tercerizada5 = new Tercerizada(Proveedor2, false, new DateTime(2024, 05, 12), "ActTercerizada5", "Descripcion tercerizada 5", new DateTime(2023, 05, 12), 8, 0, 15);
            Tercerizada Tercerizada6 = new Tercerizada(Proveedor2, false, new DateTime(2024, 06, 12), "ActTercerizada6", "Descripcion tercerizada 6", new DateTime(2023, 06, 12), 8, 0, 10);
            ...
            Tercerizada Tercerizada9 = new Tercerizada(Proveedor3, false, new DateTime(2024, 09, 12), "ActTercerizada9", "Descripcion tercerizada 9", new DateTime(2023, 09, 12), 18, 0, 15);
            ...
            Tercerizada Tercerizada12 = new Tercerizada(Proveedor4, false, new DateTime(2024, 12, 12), "ActTercerizada12", "Descripcion tercerizada 12", new DateTime(2023, 12, 12), 10, 0, 20);
            Tercerizada Tercerizada13 = new Tercerizada(Proveedor5, false, new DateTime(2024, 01, 12), "ActTercerizada13", "Descripcion tercerizada 13", new DateTime(2023, 01, 12), 12, 0, 20);
        ...
        public void AgregarActividadInterna(Interna interna)
        {
            if (interna == null)
            {
                throw new Exception("Actividad interna no válida");
            }
            interna.Validar();
        ...
        public void AgregarActividadTercerizada(Tercerizada tercerizada)
        {
            if (tercerizada == null)
            {
                throw new Exception("Actividad tercerizada no válida");
            }
            tercerizada.Validar();
